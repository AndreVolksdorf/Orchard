$(document).ready(function () {
    ...
    $('li.dropdown-menu i').removeClass('fa-angle-down').addClass('fa-angle-right').addClass('pull-right');

    // make sure submenu item links work
    $('li.dropdown-menu > .dropdown > a').click(function () {
...
$('.equal-heights').equalize();
$('.equal-sections').equalize({ children: '.section' });
$('.equal-articles').equalize({ children: 'article' });
$('.themenfelder-gruppen-term').children('.content-items').each(function () {
    $(this).equalize({ children: 'article' });
});
$('.groups.content-items').equalize({ children: 'article' });
$('.departments.content-items').equalize({ children: 'article' });
$('.group-departments').equalize({ children: 'article' });
