...
namespace SmartPage.Community.Roles.Services {
    ...
    public class RoleService : IRoleService {
        ...
        private readonly IRepository<GroupRolesPartRecord> _userRolesRepository;
        ...
        public RoleService(
            ...
            IRepository<GroupRolesPartRecord> userRolesRepository,
        ...
        public void DeleteRole(int id) {
            ...
            var currentGroupRoleRecords = _userRolesRepository.Fetch(x => x.RoleRecord.Id == id);
            foreach(var userRoleRecord in currentGroupRoleRecords) {
