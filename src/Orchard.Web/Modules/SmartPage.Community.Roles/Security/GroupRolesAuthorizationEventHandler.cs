...
namespace SmartPage.Community.Roles.Security
{
    public class RolesAuthorizationEventHandler : IAuthorizationServiceEventHandler
    {
        ...
        public RolesAuthorizationEventHandler(IWorkContextAccessor workContextAccessor, IRoleService roleService)
        {
