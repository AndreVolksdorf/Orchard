...
namespace NGM.Forum.Controllers {
    ...
    public class PostController : Controller, IUpdateModel {
        ...
        public ActionResult Create(int contentId) {
            ...
            if (!_orchardServices.Authorizer.Authorize(Permissions.CreatePost, part, T("Not allowed to create post")))
        ...
        public ActionResult CreatePOST(int contentId) {
            ...
            if (!_orchardServices.Authorizer.Authorize(Permissions.CreatePost, post, T("Not allowed to create post")))
                return new HttpUnauthorizedResult();
