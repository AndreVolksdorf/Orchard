...
namespace NGM.Forum.Controllers {
    ...
    public class ThreadController : Controller, IUpdateModel {
        ...
        public ActionResult Create(int forumId) {
            ...
            if (!_orchardServices.Authorizer.Authorize(Permissions.CreateThread, thread, T("Not allowed to create thread")))
        ...
        public ActionResult CreatePOST(int forumId) {
            ...
            if (!_orchardServices.Authorizer.Authorize(Permissions.CreateThread, post, T("Not allowed to create post")))
                return new HttpUnauthorizedResult();
        ...
        private bool IsAllowedToCreatePost(PostPart postPart) {
            return _authorizationService.TryCheckAccess(Permissions.CreateThread, _authenticationService.GetAuthenticatedUser(), postPart);
        }
