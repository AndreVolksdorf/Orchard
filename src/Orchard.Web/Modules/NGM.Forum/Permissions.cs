...
namespace NGM.Forum {
    public class Permissions : IPermissionProvider {
        ...
        public static readonly Permission CreateThread = new Permission { Description = "Allows you to create threads and posts", Name = "CreateThread", ImpliedBy = new[] { ManageForums } };
        public static readonly Permission CreatePost = new Permission { Description = "Allows you to create threads and posts", Name = "CreatePosts", ImpliedBy = new[] { ManageForums, CreateThread } };
