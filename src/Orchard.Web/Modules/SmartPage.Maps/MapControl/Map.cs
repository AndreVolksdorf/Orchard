...
using System.Web.UI;
using SmartPage.Maps.MapControl.Events;
using SmartPage.Maps.MapControl.Extensions;
using SmartPage.Maps.MapControl.Helpers;
using SmartPage.Maps.MapControl.MapType;
using SmartPage.Maps.MapControl.MapType.ImageMapType;
using SmartPage.Maps.MapControl.MapType.StyledMapType;
using SmartPage.Maps.MapControl.Objects;
using SmartPage.Maps.MapControl.Objects.Layers;
using SmartPage.Maps.MapControl.Objects.Layers.Heat;
using SmartPage.Maps.MapControl.Objects.Markers;
using SmartPage.Maps.MapControl.Objects.Markers.Clustering;
using SmartPage.Maps.MapControl.Objects.Markers.Events;
using SmartPage.Maps.MapControl.Objects.Shapes.Circle;
using SmartPage.Maps.MapControl.Objects.Shapes.Polygons;
using SmartPage.Maps.MapControl.Objects.Shapes.Polyline;
    ...
    public class Map
    {
            ...
            where TMapObject : MapObject
        {
            ...
            foreach (TDataItem dataItem in dataSource)
            {
                ...
                {
                    case "SmartPage.Maps.MapControl.Objects.Markers.Marker":
                        mapObject = new Marker(this);
                        this.Markers.Add((Marker)mapObject);
                        break;
                    case "SmartPage.Maps.MapControl.Objects.Shapes.Circle.Circle":
                        mapObject = new Circle(this);
                        this.Circles.Add((Circle)mapObject);
                        break;
                    case "SmartPage.Maps.MapControl.Objects.Shapes.Polygons.Polygon":
                        mapObject = new Polygon(this);
                        this.Polygons.Add((Polygon)mapObject);
                        break;
                    case "SmartPage.Maps.MapControl.Objects.Shapes.Polyline.Polyline":
        ...
        private void Initialize()
        {
            ...
            this.MapTypeId = MapType.MapType.Roadmap.ToClientSideString();
